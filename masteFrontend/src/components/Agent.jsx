...
function Agent() {
    ...
    return (
        <>
                ...
                <h1 className="bg-blue-900 text-white mb-5 p-2 rounded-t-md">Agent Record</h1>
                ...
                <table className="min-w-full bg-white border border-gray-300">
                    ...
                    <tr className="bg-gray-100">
                        ...
                        <th className="border border-gray-300 px-4 py-2">Trasaction history</th>
                        <th className="border border-gray-300 px-4 py-2">Bookie Code</th>
